...
if (isset($_POST['sezar'])) {
    ...
    if (isset($SezarKey) && !empty($SezarKey)) {
        $cryptSezar = Cryption($Sezartext, $SezarKey, 1);
    } else {
        $cryptSezar = '';
    }
}
if (isset($_POST['md5'])) {
    $md5Text = FormSecurity($_POST['md5Text']);
    $cryptMd5 = md5($md5Text);
}
...
if (isset($_POST['base64'])) {
    ...
    $cryptBase64 = base64_encode($base64Text);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mt-3 mb-3">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="index.php">Şifrələmə</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="containers">
            <h1>Sezar Şifrələmə</h1>
            <form action="" method="POST" class="crypt_container">
                <div class="box">
                    <textarea name="sezarText" id="" placeholder="Mətn :"><?php if (isset($Sezartext)) {
                                                                                echo $Sezartext;
                                                                            }; ?></textarea>
                ...
                <div class="box">
                    <textarea name="" id="" placeholder="..."><?php if (isset($cryptSezar)) {
                                                                    echo $cryptSezar;
                                                                }; ?></textarea>
                </div>
            </form>
        ...
        <div class="containers">
            ...
            <form action="" method="POST" class="crypt_container">
                <div class="box">
                    <textarea name="md5Text" id="" placeholder="Mətn :"><?php if (isset($md5Text)) {
                                                                            echo $md5Text;
                                                                        }; ?></textarea>
                ...
                <div class="box">
                    <button name="md5" type="submit" class="btn btn-primary">RUN</button>
                </div>
                <div class="box">
                    <textarea name="" id="" placeholder="..."><?php if (isset($cryptMd5)) {
                                                                    echo $cryptMd5;
                                                                }; ?></textarea>
                </div>
            </form>
        ...
        <div class="containers">
            <h1>Reverse Şifrələmə</h1>
            <form action="" method="POST" class="crypt_container">
                <div class="box">
                    <textarea name="reverseText" id="" placeholder="Mətn :"><?php if (isset($reverseText)) {
                                                                                echo $reverseText;
                                                                            }; ?></textarea>
                ...
                <div class="box">
                    <textarea name="" id="" placeholder="..."><?php if (isset($cryptReverse)) {
                                                                    echo $cryptReverse;
                                                                }; ?></textarea>
                </div>
            </form>
        ...
        <div class="containers">
            <h1>Base64 Şifrələmə</h1>
            <form action="" method="POST" class="crypt_container">
                <div class="box">
                    <textarea name="base64Text" id="" placeholder="Mətn :"><?php if (isset($base64Text)) {
                                                                                echo $base64Text;
                                                                            }; ?></textarea>
                ...
                <div class="box">
                    <textarea name="" id="" placeholder="..."><?php if (isset($cryptBase64)) {
                                                                    echo $cryptBase64;
                                                                }; ?></textarea>
                </div>
            </form>
